package com.everyday.api.global.config;

import com.everyday.api.domain.member.repository.MemberRepository;
import com.everyday.api.domain.member.service.LoginService;
import com.everyday.api.global.jwt.filter.JwtAuthenticationProcessingFilter;
import com.everyday.api.global.jwt.service.JwtService;
import com.everyday.api.global.login.filter.JsonUsernamePasswordAuthenticationFilter;
import com.everyday.api.global.login.handler.LoginFailureHandler;
import com.everyday.api.global.login.handler.LoginSuccessJWTProvideHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET,"/mission", "/mission/{missionId}").permitAll()
