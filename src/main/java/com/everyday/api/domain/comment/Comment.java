package com.everyday.api.domain.comment;
...
//    private String filePath;
    ...
    public void confirmMission(Mission mission) {
        this.mission = mission;
        mission.addComment(this);
    }
...
//    }
    ...
    @Builder
    public Comment( Member writer, Mission mission, Comment parent, String content) {
        this.writer = writer;
        this.mission = mission;
        this.parent = parent;
        this.content = content;
